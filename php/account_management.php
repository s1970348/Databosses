...
/////////////////// WORKAROUND FOR NOT HAVING TO LOG IN, REMOVE
$_SESSION['e-mail'] = 'donald@example.com';
$_SESSION['password'] ='ilovedaisy';
...
//echo "<meta http-equiv=\"refresh\" content=\"3;index.php\">";
    ...
    echo('Welcome,'.$_SESSION['e-mail'].'.<br /> you logged in at '. date('H:i:s d-m-Y', $_SESSION['login_time']));
    
    $visiquery ='SELECT `Visibility` FROM `user` WHERE Email = "'.$_SESSION['e-mail'].'"';
    $visiqueryresult = mysql_query($visiquery) or die ('Requesting visible query failed' . mysql_error());
